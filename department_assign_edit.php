...
$department_name = $_GET['name'];
    ...
    if (isset($_POST['save'])) {
      ...
      $name=$_POST['name'];
        ...
        $sql="INSERT INTO county_facilities (department_id,name) VALUES ('$department_id','$name')";
            mysqli_query($db,$sql);
 ...
 if(isset($_POST['update_acc'])){
       ...
       $sql = "UPDATE county_facilities SET name='$name' WHERE id='$editid' ";
...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div id="mapCanvas">
            ...
            <input type="submit" name="accommodation" class="btn btn-info" value="Add New" data-toggle="modal" data-target="#accommodation"> to <label style="font-weight: 900;"><?php echo $department_name; ?></label>
            <br>
            ...
            <div style="overflow-y: scroll; height:400px;">
                  ...
                  <?php 
                   $sql= "SELECT * FROM county_facilities WHERE department_id='$department_id' ORDER BY id DESC";
